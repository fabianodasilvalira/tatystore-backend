-- ============================================================================
-- SCRIPT COMPLETO DE INICIALIZAÇÃO DO SISTEMA - VERSÃO CORRIGIDA
-- ============================================================================
...
-- ============================================================================
-- 4. CATEGORIAS (4 por empresa)
-- ============================================================================

-- Inserir categorias para Taty Perfumaria
INSERT INTO categories (name, description, company_id, is_active, created_at, updated_at)
SELECT 
    'Perfumes',
    'Perfumes importados e nacionais de alta qualidade',
    c.id,
    true,
    NOW(),
    NOW()
...
SELECT 
    'Cosméticos',
    'Produtos de beleza e cuidados com a pele',
    c.id,
    true,
    NOW(),
    NOW()
...
SELECT 
    'Higiene Pessoal',
    'Sabonetes, desodorantes e produtos de higiene',
    c.id,
    true,
    NOW(),
    NOW()
...
SELECT 
    'Presentes & Kits',
    'Kits presentes e combos especiais',
    c.id,
    true,
    NOW(),
    NOW()
...
-- Inserir categorias para Carol Perfumaria
INSERT INTO categories (name, description, company_id, is_active, created_at, updated_at)
SELECT 
    'Perfumes',
